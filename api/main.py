...
app = FastAPI(title="Brain Tumor MRI API", version="1.0.0", lifespan=lifespan)
...
def health():
    ...
    return HealthResponse(
        ...
        checkpoint_path=str(predictor.checkpoint_path.name),
...
async def predict(file: UploadFile = File(...)):
    ...
    return predictor.predict(await file.read(), file.filename)
