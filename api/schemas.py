...
class HealthResponse(BaseModel):
    ...
    architecture: str = Field(..., description="Deep learning architecture.")

    checkpoint_path: str = Field(..., description="Path of loaded model checkpoint.")

    device: str = Field(..., description="Inference device used by PyTorch.")
...
class PredictionResponse(BaseModel):
    ...
    class_index: int = Field(..., ge=0, description="Predicted class index.")

    class_name: str = Field(..., description="Predicted tumor category.")
