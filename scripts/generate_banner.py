...
def create_banner():
    ...
    for i, tech in enumerate(tech_stack):
        ...
        draw.ellipse(
            [x_offset + 14, y_offset + 14, x_offset + 22, y_offset + 22],
            fill=badge_colors[i % len(badge_colors)],
        )

        # Text inside badge
        draw.text(
            (x_offset + 30, y_offset + 9), tech, fill=(201, 209, 217), font=font_badge
        )
    ...
    nodes = [
        ...
        (1050, 120),
        (1050, 190),
        (1050, 280),  # Hidden layer 1
        (1150, 150),
        (1150, 250),  # Output layer
    ]
